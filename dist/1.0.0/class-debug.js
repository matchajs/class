...
define("matcha/class/1.0.0/class-debug", [], function(require, exports, module) {
    "use strict";
    // Helpers
    var coreToString = Object.prototype.toString, isArray = Array.isArray || function(obj) {
    ...
    function mix(target, source, filterList) {
        ...
        var item;
        for (item in source) {
            if (!source.hasOwnProperty(item) || item === "prototype" || // prototype will be enumerated on iPhone1 Safari, we should be excluded
    ...
    function implement(prop) {
        var self = this, clsMutators = Class.Mutators, parentExisted = self.parent, name, val;
        for (name in prop) {
            val = prop[name];
    ...
    function wrap(self, name, method) {
        return function() {
            var thisFn = this, tmp = thisFn.parent, parent = self.parent, result;
    ...
    Class.create = function(parent, prop) {
        ...
        var parentExisted = parent.prototype, parentProto = createProto(parentExisted);
